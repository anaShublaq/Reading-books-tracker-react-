    ...
    return (
        <>
            ...
            >
                ...
                <AsideMenuItem to='/apps/user-management/users' title='List all' hasBullet={true}/>
            ...
            >
                <AsideMenuItem to='/crafted/widgets/tables' title='List Categories' hasBullet={true}/>
            ...
            <AsideMenuItemWithSub
                ...
                fontIcon='bi-layers'
            >
                <AsideMenuItem to='/crafted/widgets/lists' title='Queries Page' hasBullet={true}/>
